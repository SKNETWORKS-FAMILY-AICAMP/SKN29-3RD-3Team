...
Python은 **3.10.x 사용을 권장**합니다. `venv`는 Python 버전을 새로 정하는 도구가 아니라, 현재 실행한 Python 버전을 그대로 사용합니다. <br>
...
FAQ 챗봇에서 내부 문서 기반 RAG 검색을 사용하려면 ChromaDB collection이 먼저 생성되어 있어야 합니다. <br>
