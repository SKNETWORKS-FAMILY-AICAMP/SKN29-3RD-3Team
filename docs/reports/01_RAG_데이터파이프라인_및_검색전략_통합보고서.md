...
![RAG 질문 유형별 검색 흐름](../assets/reports/rag_question_routing.svg)
...
![RAG 데이터 파이프라인과 collection 구성](../assets/reports/rag_collection_pipeline.svg)
...
![전처리 및 정합성 판단 기준](../assets/reports/preprocessing_decision.svg)
...
![키워드 기반 collection 라우팅](../assets/reports/keyword_routing_flow.svg)
